...
const configurations: { [env: string]: Configuration } = {
  ...
  production: {
    ...
    externalTokens: {
      ...
      MvBOND: ['0x4d2df4fdB3E9F57f367B6570eC62642D268D70cD', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  mBONDShareRewardPool: {
    name: 'Stake MvBOND, earn MSHARE',
    poolId: 4,
    sectionInUI: 2,
    contract: 'mBONDShareRewardPool',
    depositTokenName: 'MvBOND',
    earnTokenName: 'MSHARE',
    multiplier: "100x",
    finished: false,
    sort: 4,
